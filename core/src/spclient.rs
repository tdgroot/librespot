...
pub enum SpClientError {
    ...
    NoData,
    #[error("expected an entry to exist")]
    ExpectedEntry,
}
...
impl SpClient {
    ...
    pub async fn get_metadata(&self, kind: ExtensionKind, id: &SpotifyId) -> SpClientResult {
        ...
        let mut extended_metadata = res
            .extended_metadata
            .pop()
            .ok_or(SpClientError::ExpectedEntry)?;
